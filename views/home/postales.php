...
<div class="mipaginacion">
  ...
  <nav aria-label="Page navigation example " id="paginationPostales">
    <ul class="pagination">
      ...
      <li class="page-item <?php echo $_GET["pagina"]<=1 ? 'disabled': '' ?>"><a class="page-link" href="http://localhost/labotadenoel/?nombre_del_controlador=home&action=postales&pagina=<?php echo $_GET["pagina"]-1 ?>">Anterior</a></li><!--usamos un url para restasle el GET["pagina"]-1 y asi nos envia a una pagina anterior a la actual--->
      ...
      <li class="page-item <?php echo $_GET["pagina"]>=$numerodePaginas ? 'disabled': '' ?>"><a class="page-link " href="http://localhost/labotadenoel/?nombre_del_controlador=home&action=postales&pagina=<?php echo $_GET["pagina"]+1 ?>">Siguiente</a></li><!--usamos un url para sumarle el GET["pagina"]+1 y asi nos envia a una pagina siguiente a la actual--->
    </ul>
  </nav>
</div>
<div class="miClear">
